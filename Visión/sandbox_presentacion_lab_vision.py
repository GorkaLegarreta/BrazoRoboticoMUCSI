...
image = cv2.imread('Imagenes/gorka_9.png')  # Cambia la ruta de la imagen según tus necesidades
...
cv2.imwrite('Imagenes/presentacion_lab0.png', image)
...
cv2.imwrite('Imagenes/presentacion_lab1.png', image)
...
cv2.imwrite('Imagenes/presentacion_lab2.png', image)
...
cv2.imwrite('Imagenes/presentacion_lab3.png', image)
...
cv2.imwrite('Imagenes/presentacion_lab4.png', image)
